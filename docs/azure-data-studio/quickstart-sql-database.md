...
2. This article uses SQL sign-in, but Azure SQL Database also supports AAD Universal MFA authentication. Fill in the following fields using the server name, user name, and password for your Azure SQL server:
